...
public class TestSuiteController {
	...
	public ResponseEntity<List<TestSuite>> get(@PathVariable("id") String id) {
	...
	public ResponseEntity<TestSuite> update(@PathVariable("id") long id, @RequestBody @Valid TestSuite TestSuite) {
		TestSuite testsuite = testSuiteRepository.save(TestSuite);
		return new ResponseEntity<TestSuite>(testsuite, HttpStatus.CREATED);
	}
