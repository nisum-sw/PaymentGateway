...
import com.nisum.services.repository.TestSuiteRepository;

@RestController
@RequestMapping("/rest/testsuites")
public class TestSuiteSvcController {
	private TestSuiteRepository TestSuiteRepository;
	
	@Autowired
	public TestSuiteSvcController(TestSuiteRepository TestSuiteRepository) {
