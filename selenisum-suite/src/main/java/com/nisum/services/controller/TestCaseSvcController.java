...
import com.nisum.services.repository.TestCaseRepository;

@RestController
@RequestMapping("/rest/testcases")
public class TestCaseSvcController {
	private TestCaseRepository TestCaseRepository;
	
	@Autowired
	public TestCaseSvcController(TestCaseRepository TestCaseRepository) {
